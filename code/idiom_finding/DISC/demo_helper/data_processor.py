...
class DataHandler(object):
    ...
    def update_config(self):
        ...
        self.target_vocab = load_json_file(path_to_data_files['path_to_target_vocab'].replace('./', ROOT + '/').replace('demo_helper/', ''))
        self.char_vocab = load_json_file(path_to_data_files['path_to_char_vocab'].replace('./', ROOT + '/').replace('demo_helper/', ''))
        self.pos_vocab = load_json_file((path_to_data_files['path_to_pos_vocab'].replace('./', ROOT + '/').replace('demo_helper/', '')))
        self.glove_vocab = load_json_file((path_to_data_files['path_to_glove_vocab'].replace('./', ROOT + '/').replace('demo_helper/', '')))
        ...
        self.glove_embedding_layer = EmbeddingGeneratorGLOVE(self.config, path_to_data_files['path_to_glove_embed'].replace('./', ROOT + '/').replace('demo_helper/', ''))
