...
class Config:
    ...
    DATA_NAME = 'magpie'
    SPLIT = 'random' # 'random' (trains with random split) or 'typebased' (uses data partitions such that some idioms in the test data do not appear in the training data)
    ...
    PATH_TO_META_DATA = '{}/meta_data/meta_data_{}_{}.json'.format(ROOT, DATA_NAME, SPLIT)  # file that records data paths
    print(PATH_TO_META_DATA)
    ...
    PATH_TO_CHECKPOINT = join(ROOT, 'checkpoints/ReadComp_magpie_random_cross_attn-glove-char-pos-tri_latest.mdl')
